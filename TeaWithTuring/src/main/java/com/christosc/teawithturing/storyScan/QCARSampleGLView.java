...
public class QCARSampleGLView extends GLSurfaceView {
    ...
    public void init(int flags, boolean translucent, int depth, int stencil) {
        ...
        Log.d(StoryScanActivity.TAG, "Using OpenGL ES " + (mUseOpenGLES2 ? "2.0" : "1.x"));
        Log.d(StoryScanActivity.TAG, "Using " + (translucent ? "translucent" : "opaque") +
    ...
    private static class ContextFactory implements GLSurfaceView.EGLContextFactory {
        ...
        public EGLContext createContext(EGL10 egl, EGLDisplay display, EGLConfig eglConfig) {
            EGLContext context;
            if (mUseOpenGLES2) {
                Log.d(StoryScanActivity.TAG, "Creating OpenGL ES 2.0 context");
                ...
                Log.d(StoryScanActivity.TAG, "Creating OpenGL ES 1.x context");
                checkEglError("Before eglCreateContext", egl);
    ...
    private static void checkEglError(String prompt, EGL10 egl) {
        ...
        while ((error = egl.eglGetError()) != EGL10.EGL_SUCCESS) {
            Log.d(StoryScanActivity.TAG, String.format("%s: EGL error: 0x%x", prompt, error));
        }
    }
